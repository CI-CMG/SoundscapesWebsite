...
```{python}
#| echo: false
display(HTML(gf.makeImage("sanctsound_scene.jpg", "soundscapeInfographic", "Infographic of icons representing examples of different sound sources in the ocean.")))
