...
```{python}
#| echo: false
display(HTML(gf.makeImage("Infographic of icons representing examples of different sound sources in the ocean.", "sanctsound_scene.jpg", "soundscapeInfographic")))
