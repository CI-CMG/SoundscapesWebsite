...
```{python}
#| echo: false
display(HTML(gf.makeImage("sanctsound_scene_no_logo.jpg", "soundscapeInfographic", altText= "Infographic of icons representing examples of different sound sources in the ocean.")))
