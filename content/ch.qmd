...
display(HTML(gf.makeImage("plot_CH01-4300-5000_HMDstatus.jpg", "FOI")))
display(HTML(gf.makeImage("plot_NRS13-57-70_HMDstatus.jpg", "FOI2")))
display(HTML(gf.makeImage("plot_NRS13-112-141_HMDstatus.jpg", "FOI3")))
```
:::
