...
display(HTML(gf.makeImage("CH01_Box.png", "Seasonal Fish Choruses", altText= "Boxplots of presence of boccacio rockfish and plainfin midshipman chorusing by week in the Chumash Heritage National Marine Sanctuary. Fish vocalize here seasonally, between July and October.")))
...
display(HTML(standardTextDict["diel fish CH fc"]))
```
