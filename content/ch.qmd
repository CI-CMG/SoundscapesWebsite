...
#display(HTML(gf.makeButtons(sites, "plot_***HMDstatus.jpg", "FOI"))) 

display(HTML(gf.makeButtons(sitesFOI, "plot_***-4300-5000_HMDstatus.jpg", "FOI")))

display(HTML(gf.makeButtons(sitesFOI2, "plot_***-63_HMDstatus.jpg", "FOI2")))
display(HTML(gf.makeButtons(sitesFOI2, "plot_***-125_HMDstatus.jpg", "FOI3")))
```
:::
...
display(HTML(gf.makeImage("CH01_FinalRosePlotV2.png", " Daily Fish Choruses")))
```
