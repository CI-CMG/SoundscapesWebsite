...
display(HTML(gf.makeImage("AS_Humpback.png", "humpbackAS", altText= "Humpback whale presence by month; whales were detected between August and November (June 2015–April 2016), with a data gap from April to June.")))
