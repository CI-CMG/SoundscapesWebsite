...
---
title: "Cordell Bank and Greater Farallones National Marine Sanctuary Soundscape Report"
date: "today"
output: 
  html_document: 
    fig_caption: true
...
display(HTML(gf.makeButtons(sites, "plot_***-112-141_HMDstatus.jpg", "FOI2")))
```
:::
