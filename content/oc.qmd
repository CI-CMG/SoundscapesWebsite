...
display(HTML(gf.makeButtons(sites, "plot_***-63_HMDstatus.jpg", "FOI")))
display(HTML(gf.makeButtons(sites, "plot_***-125_HMDstatus.jpg", "FOI2")))
...
display(HTML(gf.makeImage("plot_OC02OrcaDetections.jpg", "time series orca")))


display(HTML(standardTextDict["humpback-whales-OC"]))
display(HTML(gf.makeImage("plot_OCNMSHumpbackWhaleDetections.jpg", "time series humpback")))
