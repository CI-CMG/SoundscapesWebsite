...
display(HTML(gf.makeButtons(sites, "plot_***-112-141_HMDstatus.jpg", "FOI")))
...
display(HTML(gf.makeImage("plot_OCNMSHumpbackWhaleDetections.jpeg", "time series humpback")))
