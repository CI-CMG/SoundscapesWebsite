...
display(HTML(gf.makeImage("MB01_FinalHist.png", "Seasonal Fish Choruses", altText= "Histograms of proportion of fish chorusing hours detected for five fish species by month in the Monterey Bay National Marine Sanctuary, comparing the most recent recording year (2023) to the previous year (2022).")))
...
display(HTML(standardTextDict["diel fish MB fc"]))
```
...
display(HTML(gf.makeImage("plot_MBNMSHumpbackWhaleDetections.jpg", "time series humpback", altText= "Scatter plot with GAM model curves of weekly count of humpback whale acoustic presence for song and non song calls in the Monterey Bay National Marine Sanctuary. Non-song calls peak during summer whereas song calls peak fall through spring with many more song calls than non-song calls.")))
display(HTML(standardTextDict["humpback curve MB fc"]))
