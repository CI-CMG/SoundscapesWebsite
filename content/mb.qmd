...
display(HTML(gf.makeButtons(sites, "plot_***_HMDSeasonalSPL.jpg", "Seasons")))
infoHtml = f'''
...
display(HTML(gf.makeButtons(sites, "plot_***_HMDYearSPL.jpg", "YearSPL")))
...
display(HTML(gf.makeButtons(sitesFOI, "plot_***-63_HMDstatus.jpg", "FOI")))
display(HTML(gf.makeButtons(sitesFOI, "plot_***-100-800_HMDstatus.jpg", "FOI2")))

display(HTML(gf.makeButtons(sitesFOI2, "plot_***-40-48_HMDstatus.jpg", "FOI3")))
display(HTML(gf.makeButtons(sitesFOI2, "plot_***-169_HMDstatus.jpg", "FOI4")))
```
:::
...
display(HTML(gf.makeButtons(fishsites, "***_FinalRosePlotV2.png", "daily_fish_choruses")))
```
...
display(HTML(gf.makeImage("plot_MBNMSHumpbackWhaleDetections.jpg", "time series humpback")))
