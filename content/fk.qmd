...
display(HTML(gf.makeButtons(sites, "plot_***-57-70_HMDstatus.jpg", "FOI")))
display(HTML(gf.makeButtons(sites, "plot_***-113-141_HMDstatus.jpg", "FOI2")))
```
:::
...
display(HTML(gf.makeButtonsWithLabels(GGrouperGraphs, GGrouperGraphsLabels, "FK01_***.png", "g_grouper")))
