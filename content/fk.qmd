...
###When do fish courses contribute to the soundscape?
```{python}
#| echo: false

display(HTML(standardTextDict["goliath grouper"]))
display(HTML(gf.makeImage("FK01_daily_activity.png", "daily activity")))
display(HTML(gf.makeImage("FK01_diel_patterns.png", "diel patterns")))
```
...
display(HTML(standardTextDict["goliath grouper 2']))
```
