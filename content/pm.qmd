...
display(HTML(gf.makeImage("raster_by_site_Humpback_PNMS.png", "rasterHumpbackPM", 900)))
...
display(HTML(gf.makeImage("seasonal_bar_month_2_Parrotfish_crunch.png", "rasterfish1PM")))
