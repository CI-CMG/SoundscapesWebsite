...
display(HTML(gf.makeButtons(sites, "plot_***-100-630_HMDstatus.jpg", "FOI")))
display(HTML(gf.makeButtons(sites2, "plot_***-16000_HMDstatus.jpg", "FOI2")))
```
:::
...
display(HTML(gf.makeImage("raster_by_site_Humpback_PNMS.png", "rasterHumpbackPM")))
```
...
display(HTML(gf.makeImage("seasonal_bar_month_2_Parrotfish_crunch_PNMS.png", "rasterfish1PM")))

display(HTML(standardTextDict["fish-2-PM"]))
display(HTML(gf.makeImage("fish_nighttime_activity.png", "rasterfish2PM")))
```
