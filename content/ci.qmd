...
display(HTML(gf.makeButtons(sites, "plot_***-6998-11220_HMDstatus.jpg", "FOI2")))
```
:::
...
display(HTML(gf.makeImage("plot_CINMSHumpbackWhaleDetections.jpeg", "time series humpback")))
