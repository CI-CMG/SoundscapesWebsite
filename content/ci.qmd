...
display(HTML(gf.makeButtons(sites, "plot_***-40-48_HMDstatus.jpg", "FOI")))

display(HTML(gf.makeButtons(sitesFOI, "plot_***-5000-7000_HMDstatus.jpg", "FOI2")))
display(HTML(gf.makeButtons(sitesFOI2, "plot_***-57-70_HMDstatus.jpg", "FOI3")))
```
:::
...
display(HTML(gf.makeButtons(fishsites, "***_FinalRosePlot.jpg", "daily_fish_choruses")))
```
...
display(HTML(gf.makeImage("plot_CINMSHumpbackWhaleDetections.jpg", "time series humpback")))
